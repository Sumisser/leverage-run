  ...
  return (
    <div className={cn("grid gap-2", className)}>
      <Popover>
        ...
        <PopoverContent className="w-auto p-0 flex flex-row rounded-3xl overflow-hidden border-slate-200 card-shadow" align="start">
          <div className="flex flex-col border-r border-slate-100 p-2 bg-slate-50/50 min-w-[120px]">
            ...
            {presets.map((p) => (
              <Button
                key={p.label}
                variant="ghost"
                className="justify-start text-[11px] font-bold h-8 px-3 rounded-xl hover:bg-primary/10 hover:text-primary transition-all text-slate-600"
